...
notes = {1: {'title': 'First note', 'text': 'This is my first note', 'date': '10-1-2020'},
             2: {'title': 'Second note', 'text': 'This is my second note', 'date': '10-1-2020'},
             3: {'title': 'Third note', 'text': 'This is my third note', 'date': '10-1-2020'}
            }
...
@app.route('/index')
def index():
    #a_user = {'name': 'Lucas', 'email': "ldickso4@uncc.edu"}
    if session.get('user'):
